        ...
        <div class="col-lg-10 offset-lg-1">
            <div class="card">
                <div class="card-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-auto category-breadcrumb">
                                        ...
                                        @foreach($category->ancestors as $ancestor)
                                            <!-- 添加一个名为该祖先类目名的链接 -->
                                                <span class="category"><a href="{{ route('products.index', ['category_id' => $ancestor->id]) }}">{{ $ancestor->name }}</a></span>
                                                <span>&gt;</span>
                                        @endforeach
                                        <!-- 最后展示出当前类目名称 -->
                    ...
                    <div class="float-right">{{ $products->appends($filters)->links() }}</div>  <!-- 只需要添加这一行 -->
                </div>
            </div>
        </div>
    </div>
